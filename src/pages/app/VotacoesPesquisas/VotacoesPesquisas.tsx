  ...
  return (
    ...
    <Helmet title="VotacoesPesquisas" />
      <header className="grid justify-center p-2">
        <div className="grid grid-cols items-center gap-4">
          ...
          <h2 className="opacity-50 text-base font-medium tracking-tight">
            Aqui você expressar sua opinião sobre decisões 
      ...
      <CarouselContent className="-ml-1">
        {Array.from({ length: 5 }).map((_, index) => (
          <CarouselItem key={index} className="pl-1 md:basis-1/2 lg:basis-1/3">
            <div className="p-3">
              <Card className="bg-[#525151]">
                <CardContent className="flex aspect-square items-center justify-center p-6">
                  <span> <Image  size={100} color="#fff" /> </span>
                </CardContent>
              </Card>
            </div>
          </CarouselItem>
      ...
      <div className="grid items-center justify-center min-h-screen">
        <img className="" src="https://static.wixstatic.com/media/efc233_39256fb42a1e44c4a0398579c500f599~mv2.png/v1/fill/w_618,h_314,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/urnaeletronica3d2022_videorapido.png" />
      </div>
    </div>
  )
}
